...
I4 - Sistema simples de autenticação com utilizador e password.
...
A4 - Aplica descontos com base no valor da compra.
A5 - Verifica se um ano é bissexto.

**Objetivo**
Este conjunto de exercícios tem como finalidade:

- Praticar estruturas condicionais em Python
- Desenvolver raciocínio lógico
- Aprender a lidar com inputs do utilizador
- Criar pequenos programas funcionais e úteis
